...
export interface EmailValidatorInterface extends utils.Interface {
  functions: {
    ...
    "verify(bytes,bytes,bytes32,string)": FunctionFragment;
  };
...
export interface EmailValidator extends BaseContract {
