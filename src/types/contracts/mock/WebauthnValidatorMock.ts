...
export interface WebauthnValidatorMockInterface extends utils.Interface {
  functions: {
...
export interface WebauthnValidatorMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WebauthnValidatorMockInterface;
